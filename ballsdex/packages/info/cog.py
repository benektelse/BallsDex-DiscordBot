...
class Info(commands.Cog):
    ...
    async def about(self, interaction: discord.Interaction):
        ...
        embed.description = (
            ...
            f"**{players_count:,}** players! They caught "
            f"**{balls_instances_count:,}** {settings.collectible_name}s!\n"
            f"**{len(self.bot.guilds):,}** servers currently playing\n\n"
            "This bot is owned by **benektelse!** The bot was created by "
            "**El Laggron!** Consider supporting El Laggron on his [Patreon!](https://patreon.com/retke) \n\n"
