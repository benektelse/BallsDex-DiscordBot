...
class Info(commands.Cog):
    ...
    async def about(self, interaction: discord.Interaction):
        ...
        embed.description = (
            ...
            f"**{balls_count:,}** icons to collect\n"
            f"**{players_count:,}** players that caught "
            f"**{balls_instances_count:,}** icons\n"
            f"**{len(self.bot.guilds):,}** servers playing\n\n"
            f"{dex_credits}\n\n"
            "Consider supporting El Laggron on "
            "[Patreon](https://patreon.com/retke) :heart:\n\n"
            f"[Discord server](https://discord.gg/raw9zRJY2F) • [Invite me](https://discord.com/oauth2/authorize?client_id=1149511675918168174) • "
